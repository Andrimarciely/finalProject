...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/andri/Documentos/finalProject/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('finalproject-py3.10' == '') {
...
alias deactivate = source '/home/andri/Documentos/finalProject/.venv/bin/deactivate.nu'
